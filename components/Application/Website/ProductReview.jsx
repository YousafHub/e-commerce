...
const ProductReview = ({ productId }) => {
    ...
    return (
        <div className="shadow rounded border">
            <div className="p-3 bg-gray-50 border-b mb-5">
            ...
            <div className="p-5">
                <div className='flex justify-between flex-wrap items-center'>
                    <div className='md:w-1/2 w-full md:flex md:gap-10 md:mb-0 mb-5'>
                        ...
                        <div className='md:w-[calc(100%-200px)]'>
                            <div className='w-full'>
                                {[5, 4, 3, 2, 1].map(rating => (
                                    <div key={rating} className='flex items-center gap-2 mb-3'>
                                        ...
                                        <div className='flex-1 flex items-center gap-2'>
                                            <Progress
                                                value={reviewCount?.percentage[rating]}
                                                className="flex-1 h-2"
                                            />
                                            <span className='text-sm w-10 text-gray-600'>{reviewCount?.rating[rating]}</span>
                                        </div>
                                    </div>
                                ))}
                            </div>
                    ...
                    <div className='md:w-1/2 w-full md:text-end text-center'>
                        <Button onClick={() => setIsReview(!isReview)} variant='outline' className="md:w-fit w-full py-6 px-10" type="button">Write Review</Button>
                    </div>
                </div>
                ...
                <>
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(handleReviewSubmit)}>
                            ...
                            <div className='mb-3'>
                                <ButtonLoading loading={loading} type='submit' text="Submit Review" className="w-full" />
                            </div>
                        </form>
                    </Form>
                </>} 
