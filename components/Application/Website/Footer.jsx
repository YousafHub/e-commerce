        ...
        <footer className='bg-gray-50 border-t'>
            <div className='grid lg:grid-cols-5 md:grid-cols-2 grid-cols-1 gap-10 py-10 lg:px-32 px-4'>
                <div className='lg:col-span-1 md:col-span-2 col-span-1'>
                    <Image src={logo.src} width={383} height={146} alt='Logo' className='w-36 mb-2' />
                    <p className='text-gray-500 text-sm'>E-store is your trusted destination for quality and conversence. From fashion to essentials, we bring everything you need right to your doorstep. Shop smart, live better ― only at E-store</p>
                </div>
                ...
                <div>
                    ...
                    <ul>
                        <li className='mb-2 text-gray-500 flex gap-2'>
                            ...
                            <span className='text-sm'>E-store Market Punjab, Pakistan 235234</span>
                        </li>
                        <li className='mb-2 text-gray-500 flex gap-2'>
                            <MdOutlinePhone size={20} />
                            <Link href="tel:+92-1232352342" className='hover:text-primary text-sm'>+92-1232352342</Link>
                        </li>
                        <li className='mb-2 text-gray-500 flex gap-2'>
            ...
            <div className='py-5 bg-gray-100'>
                <p className='text-center'>@ 2026 E-store. All Rights Reserved.</p>
            </div>
        </footer>
    )
}
