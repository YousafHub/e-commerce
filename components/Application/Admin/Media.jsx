...
const Media = ({ media, handleDelete, deleteType, selectedMedia, setSelectedMedia }) => {
  ...
  const handleCheck = () => {
    ...
    if(newSelectedMedia.includes(media._id)) {
  ...
  return (
    <div className='border border-gray-200 dark:border-gray-800 relative group rounded overflow-hidden'>
      ...
      <div className='absolute top-2 right-2 z-20'>
        <DropdownMenu>
          <DropdownMenuTrigger>
            <span className='w-7 h-7 flex items-center justify-center rounded-full cursor-pointer bg-black/50'><BsThreeDotsVertical color='#fff' /></span>
          </DropdownMenuTrigger>
      ...
      <div>
        <Image src={media?.secure_url} alt='Image' height={300} width={300}
