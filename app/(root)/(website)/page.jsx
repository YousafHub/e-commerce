    ...
    <section className='lg:px-32 px-4 sm:pt-20 pt-5 pb-10'>
      <div className='grid grid-cols-2 sm:gap-10 gap-2'>
        <div className='border rounded-lg overflow-hidden'>
          <Link href={""}>
            <Image src={banner1.src} width={banner1.width} height={banner1.height} alt='banner' className='transition-all hover:scale-110' />
          </Link>
        </div>
        <div className='border rounded-lg overflow-hidden'>
          <Link href={""}>
            <Image src={banner2.src} width={banner2.width} height={banner2.height} alt='banner' className='transition-all hover:scale-110' />
          </Link>
        </div>
      </div>
    </section>
      ...
      <section className='sm:pt-20 pt-5 pb-10'>
        <Image src={advertisingBanner.src} width={advertisingBanner.width} height={advertisingBanner.height} alt='Advertisement' className='' />
      </section>
