        ...
        {orderData && !orderData.success ?
          ...
          <div>
            <div className='mb-5'>
              ...
              </p>          <p><b>Transaction Id:</b> {orderData?.data?.transaction_id}</p>
                  ...
                  <tr key={product.variantId._id} className='md:table-row block border-b'>
                    <td className='p-3 '>
                      <div className="flex items-center gap-5">
                        <Image src={product?.variantId?.media[0].secure_url || imgPlaceholder.src} alt={product?.productId?.name} width={60} height={60} className="rounded" />
                        <div>
