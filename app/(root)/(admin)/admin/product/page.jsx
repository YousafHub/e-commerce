...
import { ADMIN_PRODUCT_SHOW, ADMIN_DASHBOARD, ADMIN_TRASH, ADMIN_PRODUCT_EDIT, ADMIN_PRODUCT_ADD } from '@/routes/AdminPanelRoute'
...
const breadcrumbData = [
    ...
    { href: ADMIN_PRODUCT_SHOW, label: 'Procuct' },
]
const ShowProduct = () => {
