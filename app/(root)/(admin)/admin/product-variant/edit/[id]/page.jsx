  ...
  useEffect(() => {
    if (getProductVariant && getProductVariant.success) {
      ...
      if(productVariant.media) {
        const media = productVariant.media.map(media => ({ _id: media._id, url: media.secure_url}))
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <div className='mb-3 mt-5'>
                <ButtonLoading loading={loading} type='submit' text="Update Product Variant" className="w-full" />
              </div>
            </form>
          </Form>
        </CardContent>
